...
export default function ServicesSection(): React.JSX.Element {
  return (
    <div data-webild-section="services" data-section="services" id="services">
      <FeaturesBento
        tag="Our Expertise"
        title="Stop Losing Opportunities. Start Growing Smarter."
        ...
        description="We build systems that help your business stay connected, respond faster, and turn more customers into results."
      />
    </div>
  );
}
